...
date: "Follow along: **bit.ly/gentle-ggplot2**"
output:
...
We'll be using an excerpt of the [gapminder](http://www.gapminder.org/data/) dataset provided by the [`gapminder` package](https://github.com/jennybc/gapminder) by Jenny Bryan.
