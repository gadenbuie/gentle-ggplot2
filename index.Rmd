...
.font150[Introduction to ggplot2]
...
---
layout: true
# How would you draw a graph by hand?
---
...
2. Add the tick marks.

3. Draw each line. Colour by country.

4. Add the axes labels.
...
*  A computer uses steps to construct a graphic.

*  Must be told relationship between the **variables** and the *visual properties* of the graph (e.g.*colour* = **country**).
...
* The "gg" in **ggplot2** stands for the "**g**rammar of **g**raphics"

* ggplot2 is the implementation of the grammar of graphics into R with some adaptations.

* it is "a powerful way of thinking about visualisation, as a way of **mapping between variables and the visual properties of geometric objects** that you can perceive. 
]
...
- Once you know the set up it is easy to
...
* There'll be examples of not-so-great plots in these slides <br> ... but that's okay.

-- 

* For an even more advanced look at ggplot I highly recommend this online workshop by Thomas Lin Pedersen.
---
layout: true
# Getting started
